...
contract LQTYToken is CheckContract, ILQTYToken {
    ...
    string internal constant _NAME = "TEDDY";
    string internal constant _SYMBOL = "TEDDY";
    ...
    constructor(
        ...
        uint256 bountyEntitlement = _1_MILLION.mul(25); // Allocate 2 million for bounties/hackathons
        _mint(_bountyAddress, bountyEntitlement);

        uint256 depositorsAndFrontEndsEntitlement = _1_MILLION.mul(50); // Allocate 32 million to the algorithmic issuance schedule
        _mint(_communityIssuanceAddress, depositorsAndFrontEndsEntitlement);

        uint256 _lpRewardsEntitlement = _1_MILLION.mul(3); // Allocate 1.33 million for LP rewards
