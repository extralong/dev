...
[Home](./index.md) &gt; [@cashteddy/lib-base](./lib-base.md) &gt; [PopulatedRedemption](./lib-base.populatedredemption.md) &gt; [increaseAmountByMinimumNetDebt](./lib-base.populatedredemption.increaseamountbyminimumnetdebt.md)
...
|  --- | --- | --- |
|  maxRedemptionRate | [Decimalish](./lib-base.decimalish.md) | Maximum acceptable  to use in the new transaction. |
