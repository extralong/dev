...
[Home](./index.md) &gt; [@cashteddy/lib-ethers](./lib-ethers.md)
...
|  Class | Description |
|  --- | --- |
|  [BlockPolledLiquityStore](./lib-ethers.blockpolledliquitystore.md) | Ethers-based  that updates state whenever there's a new block. |
...
|  [PopulatableEthersLiquity](./lib-ethers.populatableethersliquity.md) | Ethers-based implementation of . |
...
|  [ReadableEthersLiquity](./lib-ethers.readableethersliquity.md) | Ethers-based implementation of . |
|  [SendableEthersLiquity](./lib-ethers.sendableethersliquity.md) | Ethers-based implementation of . |
...
|  --- | --- |
|  [BlockPolledLiquityStoreExtraState](./lib-ethers.blockpolledliquitystoreextrastate.md) | Extra state added to  by [BlockPolledLiquityStore](./lib-ethers.blockpolledliquitystore.md)<!-- -->. |
...
|  --- | --- |
|  [BlockPolledLiquityStoreState](./lib-ethers.blockpolledliquitystorestate.md) | The type of [BlockPolledLiquityStore](./lib-ethers.blockpolledliquitystore.md)<!-- -->'s . |
