...
[Home](./index.md) &gt; [@cashteddy/lib-base](./lib-base.md) &gt; [PopulatableLiquity](./lib-base.populatableliquity.md)
...
|  [approveUniTokens(allowance)](./lib-base.populatableliquity.approveunitokens.md) | Allow the liquidity mining contract to use Uniswap ETH/LUSD LP tokens for . |
...
|  [pngApproveUniTokens(allowance)](./lib-base.populatableliquity.pngapproveunitokens.md) | Allow the liquidity mining contract to use Png Pool2 LP tokens for . |
...
|  [tjApproveUniTokens(allowance)](./lib-base.populatableliquity.tjapproveunitokens.md) | Allow the liquidity mining contract to use TJ Pool2 LP tokens for . |
...
|  [transferCollateralGainToTrove()](./lib-base.populatableliquity.transfercollateralgaintotrove.md) | Transfer  from Stability Deposit to Trove. |
...
|  [withdrawGainsFromStabilityPool()](./lib-base.populatableliquity.withdrawgainsfromstabilitypool.md) | Withdraw  and  from Stability Deposit. |
