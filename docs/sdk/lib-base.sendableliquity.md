...
[Home](./index.md) &gt; [@cashteddy/lib-base](./lib-base.md) &gt; [SendableLiquity](./lib-base.sendableliquity.md)
...
|  [approveUniTokens(allowance)](./lib-base.sendableliquity.approveunitokens.md) | Allow the liquidity mining contract to use Uniswap ETH/LUSD LP tokens for . |
...
|  [pngApproveUniTokens(allowance)](./lib-base.sendableliquity.pngapproveunitokens.md) | Allow the liquidity mining contract to use Png Pool2 LP tokens for . |
|  [pngExitLiquidityMining()](./lib-base.sendableliquity.pngexitliquiditymining.md) | Withdraw all staked LP tokens from liquidity mining and claim reward. |
...
|  [tjApproveUniTokens(allowance)](./lib-base.sendableliquity.tjapproveunitokens.md) | Allow the liquidity mining contract to use TJ Pool2 LP tokens for . |
...
|  [transferCollateralGainToTrove()](./lib-base.sendableliquity.transfercollateralgaintotrove.md) | Transfer  from Stability Deposit to Trove. |
...
|  [withdrawGainsFromStabilityPool()](./lib-base.sendableliquity.withdrawgainsfromstabilitypool.md) | Withdraw  and  from Stability Deposit. |
