...
[Home](./index.md) &gt; [@cashteddy/lib-base](./lib-base.md) &gt; [TransactableLiquity](./lib-base.transactableliquity.md)
...
|  [approveUniTokens(allowance)](./lib-base.transactableliquity.approveunitokens.md) | Allow the liquidity mining contract to use Uniswap ETH/LUSD LP tokens for . |
...
|  [pngApproveUniTokens(allowance)](./lib-base.transactableliquity.pngapproveunitokens.md) | Allow the liquidity mining contract to use Png Pool2 LP tokens for . |
...
|  [tjApproveUniTokens(allowance)](./lib-base.transactableliquity.tjapproveunitokens.md) | Allow the liquidity mining contract to use TJ Pool2 LP tokens for . |
...
|  [transferCollateralGainToTrove()](./lib-base.transactableliquity.transfercollateralgaintotrove.md) | Transfer  from Stability Deposit to Trove. |
...
|  [withdrawGainsFromStabilityPool()](./lib-base.transactableliquity.withdrawgainsfromstabilitypool.md) | Withdraw  and  from Stability Deposit. |
