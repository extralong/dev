...
[Home](./index.md) &gt; [@cashteddy/lib-base](./lib-base.md) &gt; [TransactableLiquity](./lib-base.transactableliquity.md) &gt; [adjustTrove](./lib-base.transactableliquity.adjusttrove.md)
...
|  maxBorrowingRate | [Decimalish](./lib-base.decimalish.md) | Maximum acceptable  if <code>params</code> includes <code>borrowLUSD</code>. |
